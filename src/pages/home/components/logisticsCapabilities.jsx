        ...
        <div className="px-[20px] lg:px-[50px] w-full">
          <div className="block md:flex gap-[5rem]">
            <div className="content_wrap_one w-[100%] md:w-[60%]">
              ...
              <h1 className='text-gray-800 mt-[50px] font-[700] text-[40px] leading-[40px] md:text-[66px] md:leading-[66px] xl:text-[114px] xl:leading-[114px]'>
                Logistics <br /> Capabilities
              </h1>
              <hr className='mt-9' />
              <h3 className='mt-5 text-[18px] leading-[18px] lg:text-[32px] lg:leading-[32px] text-gray-800 font-[400]'>
                Delivering Possibilities, On Time
              </h3>
              <p className='mt-5 w-fit text-[16px] lg:text-[17px] text-gray-700'>
